 ...
 */
class Version20161020122847 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE pf_payment_method DROP updated_at, DROP version, CHANGE created_at created_at DATETIME DEFAULT NULL');
    }
}
